...
NAME = "ZenPacks.trebortech.layout"
VERSION = "1.0.0"
AUTHOR = "TreborTech"
LICENSE = ""
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.trebortech']
PACKAGES = ['ZenPacks', 'ZenPacks.trebortech', 'ZenPacks.trebortech.layout']
INSTALL_REQUIRES = []
COMPAT_ZENOSS_VERS = ">=4.1.70"
PREV_ZENPACK_NAME = "layout"
# STOP_REPLACEMENTS
################################
